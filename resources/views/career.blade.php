...
<div class="banner row no-margin" style="background-image: url('{{ asset('asset/img/banner-bg.jpg') }}');">
    ...
    <div class="container">
        <div class="col-md-8">
            <h2 class="banner-head"><span class="strong">The Field of Joy</span><br>Join when you want, make your desired career with us</h2>
        </div>
        <div class="col-md-4">
...
<div class="row gray-section no-margin full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            <h2>Our Friendly Enviornment</h2>
            <div class="title-divider"></div>
...
<div class="row find-city no-margin">
    <div class="container">
        ...
        <p>Ready to make first step with us apply online.</p>
